...
resource "kubectl_manifest" "dashboard_vllm" {
  yaml_body = yamlencode({
    ...
    data = {
      "vllm-serving.json" = file("${path.module}/../../../modules/observability/dashboards/vllm-serving.json")
    }
  })
...
resource "kubectl_manifest" "dashboard_genai_overview" {
  yaml_body = yamlencode({
    ...
    data = {
      "genai-overview.json" = file("${path.module}/../../../modules/observability/dashboards/genai-overview.json")
    }
  })
